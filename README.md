This program allows for managment of field data. It makes API calls in Postman to allow for fields to be created, read, updated, and deleted. These same capabilities
